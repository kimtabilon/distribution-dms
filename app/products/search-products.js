    ...
    $(document).on('submit', '#search-product-form', function(){
        ...
        if (keywords != "") {
            // get data from the api based on search keywords
                $.getJSON("http://localhost:999/content/dm/api/datacontent/search.php?s=" + keywords, function(data){
            ...
            var json_url_td="http://localhost:999/content/dm/api/datacontent/read_paging.php";
