...
<?php 
$sql ="SELECT id from dm_distribution_users";
...
<?php 
$reciver = 'Admin';
$sql12 ="SELECT id from dm_distribution_notification where notireciver = (:reciver)";
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql6 ="SELECT id from dm_distribution_deleteduser ";
