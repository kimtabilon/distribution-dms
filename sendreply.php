...
header('location:index.php');
  ...
  {	
    ...
    $sqlnoti="insert into dm_distribution_notification (notiuser,notireciver,notitype) values (:notiuser,:notireciver,:notitype)";
	...
	$sql="insert into dm_distribution_feedback (sender, reciver, feedbackdata) values (:user,:reciver,:description)";
...
<body>
<?php
		$sql = "SELECT * from dm_distribution_users;";
		$query = $dbh -> prepare($sql);
		$query->execute();
