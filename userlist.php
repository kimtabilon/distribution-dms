...
$sql = "delete from dm_distribution_users WHERE id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> execute();

$sql2 = "insert into dm_distribution_deleteduser (email) values (:name)";
...
if(isset($_REQUEST['unconfirm']))
	...
	$memstatus=1;
	$sql = "UPDATE dm_distribution_users SET status=:status WHERE  id=:aeid";
	$query = $dbh->prepare($sql);
...
<?php $sql = "SELECT * from  dm_distribution_users ";
$query = $dbh -> prepare($sql);
$query->execute();
