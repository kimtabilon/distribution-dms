...
if(isset($_POST['submit']))
  {	
	...
	$sql="UPDATE dm_distribution_admin SET username=(:name), email=(:email)";
...
<?php 
$reciver = 'Admin';
$sql = "SELECT * from  dm_distribution_notification where notireciver = (:reciver) order by time DESC";
$query = $dbh -> prepare($sql);
